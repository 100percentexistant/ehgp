<div align="center">
  ...
  <h4><strong>Disclaimer</strong> this is NOT an official application for EHGP, but it is a third-party application which only receives content from the EHGP API.<h4>
